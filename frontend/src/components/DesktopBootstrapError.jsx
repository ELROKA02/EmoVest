...
const errorMessage = (error) => {
  ...
  return 'Error de inicio desconocido.'
}
    ...
    <main className="min-h-screen bg-[#050a10] px-6 py-12 text-white">
      <section className="mx-auto flex min-h-[70vh] max-w-xl flex-col items-center justify-center text-center">
        ...
        <button
          ...
          onClick={handleRetry}
          disabled={retrying}
          className="mt-6 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold transition hover:bg-blue-500 disabled:cursor-wait disabled:opacity-70"
        >
